...
public class AdapterGraphics extends BaseAdapter{
    ...
    public AdapterGraphics(Context context, ArrayList<RezultEnt> list){
 	...
 	static class ViewHolder{
 		...
 		public TextProgressBar item_progress;
 	}
 	...
 	public View getView(final int position, View convertView, ViewGroup parent) {
 		 final ViewHolder vh1;
 		   ...
 		   if(convertView != null){
 			    ...
 			    vh1.item_progress = (TextProgressBar)convertView.findViewById(R.id.item_progress);
 			    convertView.setTag(vh1);
 		   }
 		  vh1.item_date.setText(List.get(position).getDate());
 		  vh1.item_progress.setProgress(Integer.parseInt("" + List.get(position).getRezult()));
 		  vh1.item_progress.setText(vh1.item_progress.getProgress() + "%");
 		  return convertView;
 	}	
}
