...
public class MainMenu extends Activity {
	...
	Button btn_words, btn_kadr, btn_two_word, btn_asociat, btn_stat;
	Context context;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		btn_asociat.setOnClickListener(new OnClickListener() {//обробка кліку по кнопці асоц. картки
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(context, Asociative.class); //перходимо на екран двохстр. карток
				startActivity(intent);
			}
		});
		...
		btn_stat.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(context, Statistics.class);//перходимо на екран статистики
				startActivity(intent);
			}
		});
	}
